...
Demo = {
  ...
  report: function(blocks, w, h) {
    ...
    Demo.el.nofit.html("Nu au incaput (" + nofit.length + ")");// + nofit.join(", ")).toggle(nofit.length > 0);

    Demo.info = {all:blocks.length, nofit:nofit.length, fit:blocks.length - nofit.length}
